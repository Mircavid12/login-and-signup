...
function Sidebar() {
    ...
    return (
        <div>
		    ...
		    <div className="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a onClick={()=>history.push('/')} style={{cursor:'pointer'}}><i className="fa fa-tachometer"></i><span>Login</span></a></li>
		        <li id="menu-home" ><a onClick={()=>history.push('/signup')} style={{cursor:'pointer'}}><i className="fa fa-tachometer"></i><span>Signup</span></a></li>
		        <li id="menu-home" ><a onClick={()=>history.push('/dashboard')} style={{cursor:'pointer'}}><i className="fa fa-tachometer"></i><span>Dashboard</span></a></li>
